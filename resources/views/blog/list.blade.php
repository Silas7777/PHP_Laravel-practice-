            ...
            <div class="col-4">
                <form action="">
                    <div class="card">
                        <div class="card-body">
                            <div class="my-2">
                                <input type="text" name="" class="form-control w-100" placeholder="Enter Blog Title...">
                            </div>
                             <div class="my-2">
                                <textarea name="" id="" cols="30" rows="10" placeholder="Enter Message..." class="form-control w-100"></textarea>
                            </div>
                             <div class="my-2">
                                <input type="file" name="" class="form-control w-100" placeholder="">
                            </div>
                            <div class="my-2">
                                <input type="text" name="" class="form-control w-100" placeholder="Enter Owner Name...">
                            </div>
                            <div class="my-2">
